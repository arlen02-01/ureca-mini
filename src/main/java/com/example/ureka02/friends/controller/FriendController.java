...
public class FriendController {
    ...
    @PostMapping("/request")
    public ResponseDto<FriendDto> sendFriendRequest(@RequestParam("receiverName") String receiverName, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public ResponseDto<Boolean> acceptFriendRequest(@PathVariable("friendshipId") Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public ResponseDto<Boolean> rejectFriendRequest(@PathVariable("friendshipId") Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
    ...
    public ResponseDto<Boolean> deleteFriend(@PathVariable("friendshipId") Long friendshipId, @AuthenticationPrincipal CustomUserDetails user) {
